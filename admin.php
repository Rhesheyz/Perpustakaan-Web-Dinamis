    ...
    <div class="container mx-auto p-4">
        ...
        <table class="w-full mb-8 border">
            <thead>
                <tr>
                    ...
                    <th class="border border-black px-4 py-2">Telpon</th>
                    <th class="border border-black px-4 py-2">Aksi</th>
                </tr>
            </thead>
            <tbody>
        ...
        <form action="admin.php" method="post" class="mb-8">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="id_buku" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Kategori -->
            <div class="mb-4">
                <label for="kategori" class="block text-sm font-medium text-gray-600">Kategori:</label>
                <input type="text" name="kategori" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Nama Buku -->
            <div class="mb-4">
                <label for="nama_buku" class="block text-sm font-medium text-gray-600">Nama Buku:</label>
                <input type="text" name="nama_buku" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Harga -->
            <div class="mb-4">
                <label for="harga" class="block text-sm font-medium text-gray-600">Harga:</label>
                <input type="text" name="harga" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Stock -->
            <div class="mb-4">
                <label for="stok" class="block text-sm font-medium text-gray-600">Stock:</label>
                <input type="text" name="stok" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Penerbit -->
            <div class="mb-4">
                <label for="penerbit" class="block text-sm font-medium text-gray-600">Penerbit:</label>
                <input type="text" name="penerbit" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>
        ...
        <form action="admin.php" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="id_penerbit" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Nama -->
            <div class="mb-4">
                <label for="nama" class="block text-sm font-medium text-gray-600">Nama:</label>
                <input type="text" name="nama" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Alamat -->
            <div class="mb-4">
                <label for="alamat" class="block text-sm font-medium text-gray-600">Alamat:</label>
                <input type="text" name="alamat" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Kota -->
            <div class="mb-4">
                <label for="kota" class="block text-sm font-medium text-gray-600">Kota:</label>
                <input type="text" name="kota" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>

            <!-- Telepon -->
            <div class="mb-4">
                <label for="telepon" class="block text-sm font-medium text-gray-600">Telepon:</label>
                <input type="text" name="telepon" required class="mt-1 p-2 border border-black rounded-md w-full">
            </div>
